...
// Program ID.
//
// Random keypair generated by anchor build during the initial V1
// scaffold. Before mainnet deploy we grind a vanity that fits the
// wrappedbulls product family (consistent with WrappedFactory's
// "Wrap..." prefix), update this declare_id, and rebuild.
// =====================================================================
declare_id!("BU11s1akingProgram1111111111111111111111111");
