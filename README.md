...
[wrappedbulls.com](https://wrappedbulls.com) · [@wrappedbulls](https://x.com/wrappedbulls)
...
holding 1,000,000 $WBULL, with the vault's authority derived from the NFT mint
...
NFT on Ethereum. WrappedBulls uses Solana PDAs to bind a token to a
...
$WBULL has not launched on pump.fun.** The public site
([wrappedbulls.com](https://wrappedbulls.com)) is intentionally gated to a
